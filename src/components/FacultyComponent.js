                        ...
                        <CardText>
                            <a href="https://www.iiests.ac.in/IIEST/Faculty/it-abiswas" target="blank" className="cardLink">
                                <ul className="list-unstyled">
                                    ...
                                    <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> abiswas@it.iiests.ac.in</li>
                                    <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> barindam@gmail.com</li>
                                </ul>
                            </a>
                        </CardText>
                    </CardBody>
                            ...
                            <CardText>
                                <a href="https://www.iiests.ac.in/IIEST/Faculty/it-chandan" target="blank" className="cardLink">
                                    <ul className="list-unstyled">
                                        ...
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> chandangiri@gmail.com</li>
                                    </ul>
                                </a>
                            </CardText>
                        </CardBody>
                            ...
                            <CardText>
                                <a href="https://www.iiests.ac.in/IIEST/Faculty/it-rahaman_h" target="blank" className="cardLink">
                                    <ul className="list-unstyled">
                                        ...
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> rahaman_h@it.iiests.ac.in</li>
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> hafizur@vlsi.iiests.ac.in</li>
                                    </ul>
                                </a>
                            </CardText>
                        </CardBody>
                            ...
                            <CardText>
                                <a href="https://www.iiests.ac.in/IIEST/Faculty/it-ibanerjee" target="blank" className="cardLink">
                                    <ul className="list-unstyled">
                                        ...
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> ibanerjee@it.iiests.ac.in</li>
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> askforindra@yahoo.com</li>
                                    </ul>
                                </a>
                            </CardText>
                        </CardBody>
                            ...
                            <CardText>
                                <a href="https://www.iiests.ac.in/IIEST/Faculty/it-malaybhattacharyya" target="blank" className="cardLink">
                                    <ul className="list-unstyled">
                                        ...
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> malaybhattacharyya@it.iiests.ac.in</li>
                                    </ul>
                                </a>
                            </CardText>
                        </CardBody>
                            ...
                            <CardText>
                                <a href="https://www.iiests.ac.in/IIEST/Faculty/it-p_ghosal" target="blank" className="cardLink">
                                    <ul className="list-unstyled">
                                        ...
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> p_ghosal@it.iiests.ac.in</li>
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> p_ghosal.it@faculty.iiests.ac.in</li>
                                    </ul>
                                </a>
                            </CardText>
                        </CardBody>
                            ...
                            <CardText>
                                <a href="https://www.iiests.ac.in/IIEST/Faculty/it-ruchira" target="blank" className="cardLink">
                                    <ul className="list-unstyled">
                                        ...
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> ruchira.naskar@gmail.com</li>
                                    </ul>
                                </a>
                            </CardText>
                        </CardBody>
                            ...
                            <CardText>
                                <a href="https://www.iiests.ac.in/IIEST/Faculty/it-santipmaity" target="blank" className="cardLink">
                                    <ul className="list-unstyled">
                                        ...
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> santipmaity@it.iiests.ac.in</li>
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> spmaity@yahoo.com</li>
                                    </ul>
                                </a>
                            </CardText>
                        </CardBody>
                            ...
                            <CardText>
                                <a href="https://www.iiests.ac.in/IIEST/Faculty/it-sukanta" target="blank" className="cardLink">
                                    <ul className="list-unstyled">
                                        ...
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> sukanta@it.iiests.ac.in</li>
                                    </ul>
                                </a>
                            </CardText>
                        </CardBody>
                            ...
                            <CardText>
                                <a href="https://www.iiests.ac.in/IIEST/Faculty/gmail-suraroy" target="blank" className="cardLink">
                                    <ul className="list-unstyled">
                                        ...
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> suraroy@gmail.com</li>
                                        <li><i class="fa fa-lg fa-envelope" aria-hidden="true"></i> sura_roy@rediffail.com</li>
                                    </ul>
                                </a>
                            </CardText>
                        </CardBody>
